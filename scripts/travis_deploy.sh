...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "jthom17/memotecress-model-repository" ]]; then
...
echo "Your new report will be visible at https://jthom17.github.io/memotecress-model-repository in a moment."
